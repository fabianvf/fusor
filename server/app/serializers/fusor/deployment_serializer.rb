module Fusor
  class DeploymentSerializer < ActiveModel::Serializer
    ...
    attributes :id, :name, :label, :description,
               ...
               :rhev_export_domain_name, :rhev_export_domain_address, :rhev_export_domain_path,
               :rhev_iso_domain_name, :rhev_iso_domain_address, :rhev_iso_domain_path,
               :hosted_storage_name, :hosted_storage_address, :hosted_storage_path,
               :rhev_local_storage_path, :rhev_is_self_hosted, :cfme_install_loc,
